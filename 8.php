...
$sql = "CREATE TABLE IF NOT EXISTS s4bca (ID INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
name VARCHAR(15) NOT NULL, email VARCHAR(15) NOT NULL, mobile INT(20) NOT NULL)";
if (mysqli_query($conn, $sql)) {
